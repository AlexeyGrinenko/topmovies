...
public class TopMoviesDataRepository implements DataRepository {
    ...
    public TopMoviesDataRepository(MovieApiService movieApiService, MoreInfoApiService moreInfoApiService) {
